...
my_dict = {"accouricy": 99, "epochs": 1, "optimaizer": "adam"  }

print(my_dict.get("optimaizer","not found")) #get = neoa ,, delete na onno kisu hobe na
print(my_dict.get("loss","not found")) #item dictionary te na thakle not found print hobe
